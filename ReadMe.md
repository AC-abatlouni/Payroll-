...
## Table of Contents
- [Overview](#overview)
1. [Revenue Sources and Definitions](#revenue-sources-and-definitions)
2. [Calculating SCP and ICP](#calculating-scp-and-icp)
3. [Determining Weekly Sales Thresholds Based on SCP and ICP](#determining-weekly-sales-thresholds-based-on-scp-and-icp)
4. [Adjusting Sales Thresholds for Paid Days Off](#adjusting-sales-thresholds-for-paid-days-off)
5. [Applying Threshold Reductions for Tech Generated Leads (TGLs)](#applying-threshold-reductions-for-tech-generated-leads-tgls)
6. [Understanding Spiffs and Their Impact](#understanding-spiffs-and-their-impact)
7. [Calculating Commission Rate and Commission Amount](#calculating-commission-rate-and-commission-amount)
8. [Handling Refunds and Adjustments](#handling-refunds-and-adjustments)
9. [Step-by-Step Calculation Summary](#step-by-step-calculation-summary)
