...
TECH_BADGE_MAP = {
    ...
    "Jake West": "1013",
    "Jason Kerns": "1014",
    "Josue Rodriguez": "1015",
    "Justin Barron": "1016",
    "Kevin Stanley": "1017",
    "Pablo Silvas": "1018",
    "Patrick Bowerman": "1019",
    "Robert McGhee": "1020",
    "Ronnie Bland": "1021",
    "Sean Lynders": "1022",
    "Shawn Hollingsworth": "1023",
    "Stephen Starner": "1024",
    "Thomas Shawaryn": "1025",
    "Tim Kulesza": "1026",
    "Tim Miller": "1027",
    "WT Settle": "1028",
    "Will Winfree": "1029"
...
# Department code to subdepartment name mapping
SUBDEPARTMENT_MAP = {
    ...
    '24': '24 - OIL SERVICE',
    '33': '33 - PLMG DRAIN CLEANING',
    '34': '34 - PLMG EXCAVATION',
...
def format_department_revenue(revenue_data: Dict[str, Dict[str, float]], 
    ...
    Modified to match new column structure.
    """
    formatted = {}
    
    # Format subdepartment totals
    for subdept_code in ['20', '21', '22', '24', '25', '27', '30', '31', '33', '40', '41']:
